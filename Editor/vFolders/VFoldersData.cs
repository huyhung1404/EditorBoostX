...
namespace VFolders
{
    [FilePath("ProjectSettings/vFolder Data.asset", FilePathAttribute.Location.ProjectFolder)]
    public class VFoldersData : ScriptableSingleton<VFoldersData>, ISerializationCallbackReceiver
    {
        public void Save()
        {
            Save(true);
