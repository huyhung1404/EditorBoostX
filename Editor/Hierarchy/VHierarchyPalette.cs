...
{
    [FilePath("ProjectSettings/vHierarchyPalette Data.asset", FilePathAttribute.Location.ProjectFolder)]
    public class VHierarchyPalette : ScriptableSingleton<VHierarchyPalette>
    {
        public void Save()
        {
            Save(true);
