...
{
    [FilePath("ProjectSettings/vHierarchy Data.asset", FilePathAttribute.Location.ProjectFolder)]
    public class VHierarchyData : ScriptableSingleton<VHierarchyData>, ISerializationCallbackReceiver
    {
        public void Save()
        {
            Save(true);
