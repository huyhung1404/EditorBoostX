...
namespace VFolders
{
    [FilePath("ProjectSettings/vFolder Palette.asset", FilePathAttribute.Location.ProjectFolder)]
    public class VFoldersPalette : ScriptableSingleton<VFoldersPalette>
    {
        public void Save()
        { 
            Save(true);
